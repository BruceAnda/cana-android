package cn.ac.ict.cana.newversion.modules.armdroop
...
class ArmDroopTestActivity : YouMengBaseActivity() {
    ...
    fun finishTest(view: View) {
        val intent = Intent(this@ArmDroopTestActivity, FeedBackActivity::class.java)
