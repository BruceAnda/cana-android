package cn.ac.ict.cana.duaui.passwordview;
...
public class PasswordView extends AppCompatEditText {
    ...
    private void init(AttributeSet attrs) {
        ...
        eye = getToggleDrawable(getContext(), R.drawable.ic_eye, getResources().getColor(R.color.colorAccent));
        eyeWithStrike = getToggleDrawable(getContext(), R.drawable.ic_eye_strike, getResources().getColor(R.color.colorAccent));
    ...
    protected void setup() {
       ...
       // eye.setAlpha(visible && !useStrikeThrough ? alphaEnabled : alphaDisabled);
        eye.setAlpha(visible && !useStrikeThrough ? alphaEnabled : 255);
    }
