...
import static cn.refactor.lib.colordialog.R.id.btnPositive;
import static cn.refactor.lib.colordialog.R.id.btn_negative;
...
public class ColorDialogPermissionDead extends Dialog implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mPositiveBtn = (TextView) contentView.findViewById(btnPositive);
