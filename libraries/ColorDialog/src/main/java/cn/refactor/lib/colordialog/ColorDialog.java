...
public class ColorDialog extends Dialog implements View.OnClickListener {
    ...
    public ColorDialog setContentTextSize(float size) {
        mContentTextSize = size;
        return this;
    }

    public ColorDialog setTitleTextSize(float size) {
        mTitleTextSize = size;
        return this;
    }

    public ColorDialog setPositiveTextSize(float size) {
        mPositiveTextSize = size;
        return this;
    }

    public ColorDialog setNegativeTextSize(float size) {
